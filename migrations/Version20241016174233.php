 ...
 */
final class Version20241016174233 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE series ADD CONSTRAINT FK_3A10012D58ADC37E FOREIGN KEY (user_collec_id) REFERENCES user_collec (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
